# -*- coding: utf-8 -*-
"""ProwlrBot Agent - Main agent implementation.

This module provides the main ProwlrBotAgent class built on ReActAgent,
...
from .memory import ProwlrBotInMemoryMemory
...
class ProwlrBotAgent(ReActAgent):
    """ProwlrBot Agent with integrated tools, skills, and memory management.
    ...
    def __init__(
        ...
        super().__init__(
            ...
            toolkit=toolkit,
            memory=ProwlrBotInMemoryMemory(),
            formatter=formatter,
            max_iters=max_iters,
        )
    ...
    def _rebuild_mcp_client(client: Any) -> Any | None:
        ...
        rebuild_info = getattr(client, "_prowlrbot_rebuild_info", None)
