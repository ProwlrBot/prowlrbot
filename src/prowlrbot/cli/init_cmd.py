...
ProwlrBot is a personal assistant that runs in your own environment. It can connect to
...
If multiple people can message the same ProwlrBot instance with tools enabled, they
share the same delegated authority (files, commands, secrets the agent can use).

If you are not comfortable with access control and hardening, do not run ProwlrBot with
