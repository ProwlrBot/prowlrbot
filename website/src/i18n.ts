...
export const i18n: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "comparison.description": "The only open-source agent platform with 8 channels, 7 providers, multi-agent coordination, and graduated autonomy. No subscriptions. No lock-in.",
    "community.label": "Open Source",
    "community.title": "Join the pack",
    "community.description": "ProwlrBot is built by the community, for the community. Every feature, fix, and skill makes the platform better for everyone.",
    ...
    "roadmap.description": "A three-phase plan to build the most capable open-source agent platform.",
